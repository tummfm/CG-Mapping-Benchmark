...
gmx grompp -n index.ndx -f grompp.mdp -p topol.top -o topol.tpr -c conf_cg.gro --maxwarn 3
gmx mdrun -s topol.tpr -c confout.gro -o traj.trr -x traj.xtc -tableb table_b1.xvg table_a1.xvg table_d1.xvg -v